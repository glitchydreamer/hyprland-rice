...
#
#     bash ~/Documents/hyprland-rice/arch/uninstall.sh            # interactive menu
#     bash ~/Documents/hyprland-rice/arch/uninstall.sh docker     # one component
#     bash ~/Documents/hyprland-rice/arch/uninstall.sh docker isaac ros2
#     bash ~/Documents/hyprland-rice/arch/uninstall.sh --dry-run docker
#     bash ~/Documents/hyprland-rice/arch/uninstall.sh --yes all   # no prompts
#
# Flags:
